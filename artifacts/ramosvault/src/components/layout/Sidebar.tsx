      ...
      <aside className={cn(
        ...
        <div className="flex-1 overflow-y-auto py-4 px-3 space-y-0.5">
          ...
          {isAdmin && (
            <>
              <div className="pt-2 pb-1 px-3">
                <p className="text-[10px] font-semibold uppercase tracking-wider text-amber-500/70">Admin</p>
              </div>
              {navItem("/admin", <ShieldCheck className="h-4 w-4 text-primary" />, "Admin Dashboard")}
